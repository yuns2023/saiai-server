...
export interface OpsFullRequestBodyLoggingSettings {
  enabled: boolean
...
export async function getFullRequestBodyLoggingSettings(): Promise<OpsFullRequestBodyLoggingSettings> {
  const { data } = await apiClient.get<OpsFullRequestBodyLoggingSettings>('/admin/ops/full-request-body-logging')
  return data
}

export async function updateFullRequestBodyLoggingSettings(config: OpsFullRequestBodyLoggingSettings): Promise<OpsFullRequestBodyLoggingSettings> {
  const { data } = await apiClient.put<OpsFullRequestBodyLoggingSettings>('/admin/ops/full-request-body-logging', config)
  return data
}
...
export const opsAPI = {
  ...
  getFullRequestBodyLoggingSettings,
  updateFullRequestBodyLoggingSettings,
  getMetricThresholds,
