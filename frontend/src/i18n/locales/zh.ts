export default {
  ...
  keyUsage: {
    ...
    walletBalance: '钱包余额',
    payAsYouGo: '按量计费',
    keyLimitsConfigured: 'Key 消费限额',
    subscriptionWithKeyLimits: '{plan} · Key 限额',
    ...
    accountUnavailable: '计费账户当前不可用',
    // Ring card titles
    totalQuota: 'Key 总消费额度',
    limit5h: 'Key 周期限额 · 5 小时',
    limitDaily: 'Key 周期限额 · 每日',
    limit7d: 'Key 周期限额 · 7 天',
    limitWeekly: '周限额',
    limitMonthly: '月限额',
    ...
    avgDuration: '平均耗时',
    rangeRequests: '范围内请求',
    rangeInputTokens: '范围内输入',
    rangeOutputTokens: '范围内输出',
    rangeCacheTokens: '范围内缓存 Tokens',
    rangeTotalTokens: '范围内总 Tokens',
    rangeCost: '范围内消费',
    recentUsage: '最近使用记录',
    noRecentUsage: '所选时间范围内暂无使用记录',
    time: '时间',
    requestType: '请求类型',
  ...
  keys: {
    ...
    // 配额和有效期
    quotaLimit: '总消费额度',
    quotaAmount: '总消费额度 (USD)',
    quotaAmountPlaceholder: '输入 USD 总消费额度',
    quotaAmountHint: '设置此密钥可消费的最大金额。0 = 无限制。',
    quotaUsed: '累计已消费',
    reset: '重置',
    resetQuotaUsed: '将已用额度重置为 0',
    resetQuotaTitle: '确认重置累计消费',
    resetQuotaConfirmMessage: '确定要将密钥 "{name}" 的已用额度（${used}）重置为 0 吗？此操作不可撤销。',
    quotaResetSuccess: '额度重置成功',
    failedToResetQuota: '重置额度失败',
    rateLimitColumn: '周期消费限额',
    rateLimitSection: '周期消费限额',
    resetUsage: '重置',
    rateLimit5h: '5 小时消费限额 (USD)',
    rateLimit1d: '每日消费限额 (USD)',
    rateLimit7d: '7 天消费限额 (USD)',
    rateLimitHint: '设置此密钥在指定时间窗口内的最大消费额。0 = 无限制。',
    rateLimitUsage: '周期已消费',
    resetRateLimitUsage: '重置周期消费',
    resetRateLimitTitle: '确认重置周期消费',
    resetRateLimitConfirmMessage: '确定要重置密钥 "{name}" 的周期消费吗？所有时间窗口的已消费金额将归零。此操作不可撤销。',
    rateLimitResetSuccess: '周期消费已重置',
    failedToResetRateLimit: '重置周期消费失败',
    resetNow: '即将重置',
    expiration: '密钥有效期',
  ...
  usage: {
    ...
    paygUserDiscount: '用户按量折扣',
    legacyPaygAccountDiscount: '历史账号按量折扣',
    avgDuration: '平均耗时',
    ...
    reasoningEffortInherited: '按同会话主请求继承',
    endpoint: '端点',
    sessionId: '会话 ID',
  ...
  admin: {
    ...
    dashboard: {
      ...
      modelDistribution: '模型分布',
      groupDistribution: '分组使用分布',
      metricTokens: '按总 Token',
      metricActualCost: '按用户实扣',
      metricShare: '占比',
      tokenUsageTrend: 'Token 使用趋势',
      noDataAvailable: '暂无数据',
      model: '模型',
    ...
    users: {
      ...
      today: '今日',
      total: '近30天',
      claudeDevicesSummaryHint: '当前有效设备数 / 启用设备限制分组的有效上限；已撤销设备不计入',
      claudeDeviceModal: {
        title: 'Claude Code 设备',
        userId: '用户 ID：{id}',
        loading: '加载中...',
        refresh: '刷新',
        activeDevices: '有效设备',
        revokedDevices: '已撤销设备',
        totalRegistrations: '注册总数',
        empty: '暂无 Claude Code 设备记录。',
        device: '设备 #{id}',
        active: '有效',
        revoked: '已撤销',
        unavailable: '历史记录未保存原始设备 ID',
        copy: '复制',
        groupId: '分组 ID：{id}',
        firstSeen: '首次使用：{date}',
        lastSeen: '最近使用：{date}',
        ...
        revoking: '撤销中...',
        revoke: '撤销',
        revokeConfirm: '确定撤销 Claude Code 设备 #{id} 吗？',
        revokeSuccess: 'Claude Code 设备已撤销',
        revokeFailed: '撤销 Claude Code 设备失败',
        loadFailed: '加载 Claude Code 设备失败',
        copySuccess: '设备 ID 已复制',
        copyFailed: '无法复制设备 ID'
      },
      noSubscription: '暂无订阅',
    ...
    groups: {
      ...
      modelRates: {
        title: '模型专属倍率',
        placeholder: '每行一个：claude-fable-*=0.6',
        hint: '按实际计费模型匹配；支持末尾 * 通配符。精确规则优先，其次取最长前缀；留空使用分组通用倍率，0 表示免费。',
        invalid: '模型倍率格式无效：请使用 模型ID或末尾带*的前缀=0到100之间的倍率，最多四位小数，每行一个且不能重复。'
      },
      copyAccounts: {
        title: '从分组复制账号',
    ...
    accounts: {
      ...
      currentlyInUse: '使用中',
      inProgress: '进行中',
      inProgressHint: '当前有请求正在处理；下方时间为最近一次已完成请求。',
      lastCompletedHint: '最近完成请求：{time}',
      lastCompletedNever: '尚无已完成请求记录',
      ...
      // 容量状态提示
      capacity: {
        concurrencyHint: '当前活跃请求数 / 配置的并发上限',
        windowCost: {
      ...
      clearQuotaSnapshot: '清除本地额度快照',
      clearQuotaSnapshotConfirm: '确定要清除账号“{name}”的本地 5h/7d 额度快照吗？这不会修改上游订阅或主动发送请求；下一次正常请求将重新记录真实额度。',
      clearQuotaSnapshotSuccess: '本地额度快照已清除',
      clearQuotaSnapshotFailed: '清除本地额度快照失败',
      resetQuota: '重置配额',
      quotaLimit: '配额限制',
      ...
      openai: {
        ...
        upstreamProtocolCodexNativeRelayV1Desc:
          '面向上游 SAIAI Gateway：仅逐跳替换 API Key，保留 Codex HTTP/SSE 请求、WebSocket 帧、continuation、压缩和身份头。链路不设固定层数，并进行环路检测。',
        upstreamProtocolCodexNativeRelayV1Warning:
          'Base URL 必须指向支持该协议的上游 Gateway。WebSocket 使用一对一专用中继；本层仍不启用池模式重试或自定义错误码转换。',
      ...
      oauth: {
        ...
        setupTokenDirectAuth: '直接输入 Setup Token',
        setupTokenDirectDesc: '直接粘贴 Claude 生成的长期 Setup Token 创建账号，也可以粘贴包含 token 的 CLI 输出。',
        setupTokenDirectPlaceholder: '粘贴 sk-xxxxx... 或包含该 token 的 CLI 输出',
        setupTokenDirectRequired: '请输入至少一个 Setup Token',
        importSetupToken: '导入 Setup Token',
        ...
        authFailed: '授权失败',
        failedToExchangeCode: 'Claude 授权码兑换失败',
    ...
    usage: {
      ...
      sessionIdPlaceholder: '会话 ID 前缀（至少 6 位）或完整 ID...',
      sessionDiagnostics: '会话诊断',
      onlyAccountSwitchSessions: '仅账号切换会话',
      accountSwitchBadge: '{count}账号',
      accountSwitchHint: '该会话使用过多个账号',
      failoverBadge: '已切换',
      failoverHint: '该请求曾因上游错误切换账号后恢复',
      selectedUser: '已选择',
      user: '用户',
      account: '账户',
      group: '分组',
      ...
      cacheCreation5mCost: '缓存创建成本（5分钟）',
      cacheCreation1hCost: '缓存创建成本（1小时）',
      cacheCreation5mPrice: '缓存创建单价（5分钟）',
      cacheCreation1hPrice: '缓存创建单价（1小时）',
      cacheReadPrice: '缓存读取单价',
      cacheCreationPrice: '缓存创建单价',
      ...
      cleanup: {
        button: '清理',
        title: '清理使用记录',
        calendarRangeRequired: '清理任务仅支持自然日范围，请先选择今天、昨天或自定义日期。',
    ...
    ops: {
      ...
      settings: {
        ...
        requestBodyCapture: '请求 Body 采样',
        enableRequestBodyCapture: '启用指定 API Key 请求 Body 采样',
        enableRequestBodyCaptureHint: '只采样下面列出的 API Key。除排障外应保持关闭。',
        requestBodyCaptureApiKeyIds: 'API Key ID',
        requestBodyCaptureApiKeyIdsPlaceholder: '249, 250',
        requestBodyCaptureApiKeyIdsHint: '多个 API Key ID 可用逗号、空格或换行分隔。',
        captureSuccessfulRequests: '采样成功请求',
        captureSuccessfulRequestsHint: '将选中 API Key 的成功请求 Body 写入系统日志。',
        captureUpstreamRequests: '采样改写后的上游请求',
        captureUpstreamRequestsHint: '额外记录 SAIAI 改写后的最终上游 Body 与脱敏请求头。',
        requestBodyCaptureMaxBytes: '最大 Body 字节数',
        requestBodyCaptureExpiresAt: '过期时间（RFC3339）',
        requestBodyCaptureExpiresAtHint: '可选。例如：2026-05-22T12:00:00Z。过期后自动忽略。',
        autoRefresh: '自动刷新',
        enableAutoRefresh: '启用自动刷新',
        ...
        validation: {
          ...
          bodyCaptureApiKeysRequired: '启用请求 Body 采样时至少要填写一个 API Key ID',
          bodyCaptureMaxBytesRange: '最大 Body 字节数必须在 1024 到 2097152 之间'
        }
      },
      concurrency: {
        title: '并发 / 排队',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 SAiAi 用户登录',
      ...
      site: {
        ...
        apiEndpoints: 'API 线路',
        apiEndpointsHint: '配置后，用户在“使用密钥”时会随机获得一条启用线路，也可以手动切换。未配置时使用默认 API 地址。',
        apiEndpointsEmpty: '尚未配置额外线路，将使用默认 API 地址。',
        addApiEndpoint: '添加线路',
        apiEndpointName: '线路名称',
        apiEndpointNamePlaceholder: '例如：VMISS 中国优化',
        apiEndpointUrl: '线路 URL',
        apiEndpointUrlPlaceholder: 'https://edge.example.com',
        apiEndpointEnabled: '启用',
        contactInfo: '客服联系方式',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 SAiAi',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">SAiAi 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 SAiAi 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 SAiAi',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 SAiAi AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
