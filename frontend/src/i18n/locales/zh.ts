export default {
  ...
  auth: {
    ...
    oauth: {
      ...
      backToLogin: '返回登录',
      invitationRequired: '该已验证身份尚未注册，站点已开启邀请码注册，请输入邀请码完成注册。',
      invalidRegistrationToken: '一次性注册会话无效或已过期，请重新登录。',
      completeRegistration: '完成注册',
      completing: '正在完成注册...',
      completeRegistrationFailed: '注册失败，请检查邀请码后重试。',
      connectionsTitle: '已关联的登录账号',
      connectionsDescription: '将已验证的 GitHub 或 Google 身份明确绑定到当前账号。',
      confirmTotp: '使用身份验证器验证',
      confirmPassword: '确认当前密码',
      totpPlaceholder: '6 位验证码',
      passwordPlaceholder: '当前密码',
      linkReauthHint: '为保障安全，关联前必须重新完成本地验证；系统绝不会仅因邮箱相同而自动绑定。',
      linkProvider: '关联 {provider}',
      connectedTo: '已关联 {provider}',
      linkSuccess: '已成功关联 {provider}。',
      linkFailed: '无法关联该登录方式。',
      invalidTotp: '请输入有效的 6 位验证码。',
