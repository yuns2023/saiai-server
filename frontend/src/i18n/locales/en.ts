export default {
  ...
  keyUsage: {
    ...
    keyLimitsConfigured: 'Key Spending Limits',
    subscriptionWithKeyLimits: '{plan} · Key Limits',
    ...
    accountUnavailable: 'Billing account currently unavailable',
    // Ring card titles
    totalQuota: 'Key Total Spending Limit',
    limit5h: 'Key Window · 5-Hour',
    limitDaily: 'Key Window · Daily',
    limit7d: 'Key Window · 7-Day',
    ...
    rangeInputTokens: 'Range Input',
    rangeOutputTokens: 'Range Output',
    rangeCacheTokens: 'Range Cache Tokens',
    rangeTotalTokens: 'Range Total Tokens',
    rangeCost: 'Range Spending',
    recentUsage: 'Recent Usage Records',
    noRecentUsage: 'No usage records in the selected date range',
    time: 'Time',
  ...
  setup: {
    title: 'SAiAi Setup',
    description: 'Configure your SAiAi instance',
    database: {
  ...
  dashboard: {
    ...
    apiKeyFilterHint: 'Summary cards, trends, model distribution, and recent usage follow the selected Key.',
    apiKeyBreakdown: 'API Key Usage Ranking',
    apiKeyBreakdownHint: 'Aggregated for the selected range; only Key names and IDs are shown, never full keys.',
    exportKeyBreakdown: 'Export CSV',
    apiKey: 'API Key',
    status: 'Status',
    actualCost: 'Actual Cost',
    usageShare: 'Cost Share',
    lastUsed: 'Last Used',
    cacheWrite: 'Cache Write',
    cacheRead: 'Cache Read',
    noApiKeyUsage: 'No API Key data',
    noApiKeyUsageHint: 'Per-Key statistics will appear after an API Key is created and used.',
    filterThisKey: 'Filter',
    viewDetails: 'Details',
    sortActualCost: 'Sort by actual cost',
    sortRequests: 'Sort by requests',
    sortTokens: 'Sort by tokens',
    sortLastUsed: 'Sort by last used',
    sortKeyName: 'Sort by Key name',
    keyBreakdownExported: 'API Key usage CSV exported',
    keyBreakdownExportFailed: 'Failed to export API Key usage'
  },
  ...
  keys: {
    ...
    quotaAmount: 'Total Spending Limit (USD)',
    quotaAmountPlaceholder: 'Enter total spending limit in USD',
    quotaAmountHint: 'Set the maximum amount this key can spend. 0 = unlimited.',
    quotaUsed: 'Cumulative Spending',
    reset: 'Reset',
    resetQuotaUsed: 'Reset used quota to 0',
    resetQuotaTitle: 'Confirm Reset Cumulative Spending',
    ...
    rateLimitColumn: 'Spending Window Limits',
    rateLimitSection: 'Spending Window Limits',
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Spending Limit (USD)',
    rateLimit1d: 'Daily Spending Limit (USD)',
    rateLimit7d: '7-Day Spending Limit (USD)',
    rateLimitHint: 'Set the maximum spending for this key within each time window. 0 = unlimited.',
    rateLimitUsage: 'Window Spending',
    resetRateLimitUsage: 'Reset Window Spending',
    resetRateLimitTitle: 'Confirm Reset Window Spending',
    resetRateLimitConfirmMessage: 'Are you sure you want to reset the window spending for key "{name}"? Spending in all time windows will be reset to zero. This action cannot be undone.',
    rateLimitResetSuccess: 'Window spending reset successfully',
    failedToResetRateLimit: 'Failed to reset window spending',
    resetNow: 'Resetting soon',
  ...
  usage: {
    ...
    paygUserDiscount: 'Pay-as-you-go user discount',
    legacyPaygAccountDiscount: 'Legacy account PAYG discount',
    avgDuration: 'Avg Duration',
    ...
    reasoningEffortInherited: 'Inherited from same-session stream request',
    endpoint: 'Endpoint',
  ...
  admin: {
    ...
    dashboard: {
      ...
      modelDistribution: 'Model Distribution',
      groupDistribution: 'Group Usage Distribution',
      metricTokens: 'By Total Tokens',
      metricActualCost: 'By User Billed',
      metricShare: 'Share',
      tokenUsageTrend: 'Token Usage Trend',
    ...
    users: {
      ...
      creating: 'Creating...',
      updating: 'Updating...',
      paygDiscountMultiplier: 'Pay-as-you-go discount',
      ...
      columns: {
        ...
        usage: 'Usage',
        concurrency: 'Concurrency',
        claudeDevices: 'Claude Code devices',
        status: 'Status',
        created: 'Created',
        actions: 'Actions'
      },
      today: 'Today',
      total: 'Last 30d',
      claudeDevicesSummaryHint: 'Active devices / effective limit across groups with device limits enabled; revoked devices are excluded',
      claudeDeviceModal: {
        title: 'Claude Code devices',
        userId: 'User ID: {id}',
        loading: 'Loading...',
        refresh: 'Refresh',
        ...
        empty: 'No Claude Code devices recorded.',
        device: 'Device #{id}',
        active: 'Active',
        revoked: 'Revoked',
        unavailable: 'Unavailable for this historical record',
        copy: 'Copy',
        groupId: 'Group ID: {id}',
        ...
        revoking: 'Revoking...',
        revoke: 'Revoke',
        revokeConfirm: 'Revoke Claude Code device #{id}?',
        revokeSuccess: 'Claude Code device revoked',
        revokeFailed: 'Failed to revoke Claude Code device',
        loadFailed: 'Failed to load Claude Code devices',
        copySuccess: 'Device ID copied',
        copyFailed: 'Unable to copy device ID'
      },
    ...
    groups: {
      ...
      claudeCode: {
        ...
        oauthRequestGateTitle: 'OAuth Request Shape Protection',
    ...
    accounts: {
      ...
      openai: {
        ...
        upstreamProtocolPlatformCompat: 'OpenAI Platform Compatible',
        upstreamProtocolPlatformCompatDesc:
      ...
      oauth: {
        ...
        setupTokenDirectAuth: 'Enter Setup Token',
        setupTokenDirectDesc:
          'Paste a long-lived Claude Setup Token directly to create an account. You can also paste CLI output that contains the token.',
        setupTokenDirectPlaceholder: 'Paste sk-xxxxx... or CLI output containing the token',
        setupTokenDirectRequired: 'Please enter at least one Setup Token',
        importSetupToken: 'Import Setup Token',
        ...
        failedToExchangeCode: 'Failed to exchange Claude auth code',
      ...
      usageWindow: {
        ...
        gemini3Image: 'G31FI',
        claude: 'Claude',
        fableWeekly: 'Fable 7-Day Dedicated Limit',
    ...
    usage: {
      ...
      sessionIdPlaceholder: 'Session ID prefix (6+ chars) or full ID...',
      sessionDiagnostics: 'Session',
      onlyAccountSwitchSessions: 'Account switches only',
      accountSwitchBadge: '{count} accounts',
      accountSwitchHint: 'This session used multiple accounts',
      failoverBadge: 'Switched',
      failoverHint: 'This request recovered by switching accounts after an upstream error',
      ...
      cacheCreation5mCost: 'Cache Creation Cost (5m)',
      cacheCreation1hCost: 'Cache Creation Cost (1h)',
      cacheCreation5mPrice: 'Cache Creation Price (5m)',
      cacheCreation1hPrice: 'Cache Creation Price (1h)',
      ...
      cleanup: {
        ...
        calendarRangeRequired: 'Cleanup tasks require calendar dates. Select Today, Yesterday, or a custom date range first.',
    ...
    ops: {
      ...
      settings: {
        ...
        requestBodyCapture: 'Request Body Capture',
        enableRequestBodyCapture: 'Enable scoped request body capture',
        enableRequestBodyCaptureHint: 'Only API keys listed below are captured. Keep this disabled unless actively troubleshooting.',
        requestBodyCaptureApiKeyIds: 'API Key IDs',
        requestBodyCaptureApiKeyIdsPlaceholder: '249, 250',
        requestBodyCaptureApiKeyIdsHint: 'Separate multiple API key IDs with commas, spaces, or new lines.',
        captureSuccessfulRequests: 'Capture successful requests',
        captureSuccessfulRequestsHint: 'Write successful request bodies to system logs for the selected API keys.',
        captureUpstreamRequests: 'Capture rewritten upstream request',
        captureUpstreamRequestsHint: 'Also store the final upstream body and sanitized headers after SAIAI rewrites the request.',
        requestBodyCaptureMaxBytes: 'Maximum body bytes',
        requestBodyCaptureExpiresAt: 'Expires at (RFC3339)',
        requestBodyCaptureExpiresAtHint: 'Optional. Example: 2026-05-22T12:00:00Z. Expired capture is ignored automatically.',
        autoRefresh: 'Auto Refresh',
        enableAutoRefresh: 'Enable auto refresh',
        ...
        validation: {
          ...
          requestErrorRateMaxRange: 'Request error rate maximum must be between 0 and 100',
          upstreamErrorRateMaxRange: 'Upstream error rate maximum must be between 0 and 100',
          bodyCaptureApiKeysRequired: 'At least one API key ID is required when request body capture is enabled',
          bodyCaptureMaxBytesRange: 'Maximum body bytes must be between 1024 and 2097152'
        }
      },
      concurrency: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for SAiAi end-user login',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to SAiAi',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">SAiAi is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of SAiAi, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to SAiAi',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the SAiAi AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
