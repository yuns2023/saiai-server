export default {
  ...
  auth: {
    ...
    oauth: {
      ...
      callbackHint: 'If you are not redirected automatically, return to the login page.',
      callbackMissingToken: 'Missing login token. Please try again.',
      backToLogin: 'Back to Login',
      invitationRequired: 'This verified identity is not registered yet. Enter an invitation code to complete registration.',
      invalidRegistrationToken: 'The one-time registration session is invalid or expired. Please sign in again.',
      completeRegistration: 'Complete Registration',
      completing: 'Completing registration…',
      completeRegistrationFailed: 'Registration failed. Check the invitation code and try again.',
      connectionsTitle: 'Connected login accounts',
      connectionsDescription: 'Explicitly link a verified GitHub or Google identity to this account.',
      confirmTotp: 'Confirm with your authenticator code',
      confirmPassword: 'Confirm your current password',
      totpPlaceholder: '6-digit code',
      passwordPlaceholder: 'Current password',
      linkReauthHint: 'For security, linking requires fresh local verification. Matching email addresses are never linked automatically.',
      linkProvider: 'Link {provider}',
      connectedTo: '{provider} connected',
      linkSuccess: '{provider} was linked successfully.',
      linkFailed: 'Could not link this login provider.',
      invalidTotp: 'Enter a valid 6-digit authenticator code.',
