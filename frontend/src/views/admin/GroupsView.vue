        ...
        <DataTable :columns="columns" :data="groups" :loading="loading">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                v-if="!isRetiredPlatform(row.platform)"
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <div class="mt-4 border-t border-gray-100 pt-4 dark:border-dark-500">
            <div class="flex items-center justify-between gap-4">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  Allow Context 1M Beta
                </label>
                <p class="input-hint mt-1">
                  Keep <code>context-1m-2025-08-07</code> when forwarding
                  <code>anthropic-beta</code> for this group.
                </p>
              </div>
              <button
                type="button"
                @click="createForm.allow_claude_context_1m_beta = !createForm.allow_claude_context_1m_beta"
                :class="[
                  'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                  createForm.allow_claude_context_1m_beta ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
                ]"
              >
                <span
                  :class="[
          ...
          <div class="mt-4 border-t border-gray-100 pt-4 dark:border-dark-500">
            <div class="flex items-center justify-between gap-4">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.groups.claudeCode.oauthRequestGateTitle') }}
                </label>
                <p class="input-hint mt-1">
                  {{ t('admin.groups.claudeCode.oauthRequestGateHint') }}
                </p>
              </div>
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  @click="createForm.claude_oauth_request_gate_disabled = !createForm.claude_oauth_request_gate_disabled"
                  :class="[
                    'relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors',
                    !createForm.claude_oauth_request_gate_disabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
                  ]"
                >
                  <span
                    :class="[
                ...
                <span class="whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                  {{ createForm.claude_oauth_request_gate_disabled ? t('admin.groups.claudeCode.oauthRequestGateDisabled') : t('admin.groups.claudeCode.oauthRequestGateEnabled') }}
                </span>
              </div>
            </div>
          </div>
        ...
        <div v-if="editForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <div class="mt-4 border-t border-gray-100 pt-4 dark:border-dark-500">
            <div class="flex items-center justify-between gap-4">
              ...
              <button
                type="button"
                @click="editForm.allow_claude_context_1m_beta = !editForm.allow_claude_context_1m_beta"
                :class="[
                  'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                  editForm.allow_claude_context_1m_beta ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
                ]"
              >
                <span
                  :class="[
          ...
          <div class="mt-4 border-t border-gray-100 pt-4 dark:border-dark-500">
            <div class="flex items-center justify-between gap-4">
              ...
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  @click="editForm.claude_oauth_request_gate_disabled = !editForm.claude_oauth_request_gate_disabled"
                  :class="[
                    'relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors',
                    !editForm.claude_oauth_request_gate_disabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
                  ]"
                >
                  <span
                    :class="[
                ...
                <span class="whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                  {{ editForm.claude_oauth_request_gate_disabled ? t('admin.groups.claudeCode.oauthRequestGateDisabled') : t('admin.groups.claudeCode.oauthRequestGateEnabled') }}
                </span>
              </div>
            </div>
          </div>
...
const isRetiredPlatform = (platform: GroupPlatform) =>
  platform === 'antigravity' || platform === 'sora'
