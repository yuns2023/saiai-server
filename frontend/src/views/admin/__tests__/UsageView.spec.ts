...
vi.mock('@/utils/format', () => ({
  ...
  getEffectiveReasoningEffort: (log: { reasoning_effort?: string | null; reasoning_effort_effective?: string | null }) =>
    log.reasoning_effort_effective ?? log.reasoning_effort,
}))
