...
func BalanceCreditRate(v float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldEQ(FieldBalanceCreditRate, v))
}
...
func BalanceCreditRateEQ(v float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldEQ(FieldBalanceCreditRate, v))
}

// BalanceCreditRateNEQ applies the NEQ predicate on the "balance_credit_rate" field.
func BalanceCreditRateNEQ(v float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldNEQ(FieldBalanceCreditRate, v))
}

// BalanceCreditRateIn applies the In predicate on the "balance_credit_rate" field.
func BalanceCreditRateIn(vs ...float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldIn(FieldBalanceCreditRate, vs...))
}

// BalanceCreditRateNotIn applies the NotIn predicate on the "balance_credit_rate" field.
func BalanceCreditRateNotIn(vs ...float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldNotIn(FieldBalanceCreditRate, vs...))
}

// BalanceCreditRateGT applies the GT predicate on the "balance_credit_rate" field.
func BalanceCreditRateGT(v float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldGT(FieldBalanceCreditRate, v))
}

// BalanceCreditRateGTE applies the GTE predicate on the "balance_credit_rate" field.
func BalanceCreditRateGTE(v float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldGTE(FieldBalanceCreditRate, v))
}

// BalanceCreditRateLT applies the LT predicate on the "balance_credit_rate" field.
func BalanceCreditRateLT(v float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldLT(FieldBalanceCreditRate, v))
}

// BalanceCreditRateLTE applies the LTE predicate on the "balance_credit_rate" field.
func BalanceCreditRateLTE(v float64) predicate.PaymentProviderInstance {
	return predicate.PaymentProviderInstance(sql.FieldLTE(FieldBalanceCreditRate, v))
}
