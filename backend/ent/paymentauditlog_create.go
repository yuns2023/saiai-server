...
func (_c *PaymentAuditLogCreate) SetOrderID(v int64) *PaymentAuditLogCreate {
...
func (_c *PaymentAuditLogCreate) createSpec() (*PaymentAuditLog, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.OrderID(); ok {
		_spec.SetField(paymentauditlog.FieldOrderID, field.TypeInt64, value)
		_node.OrderID = value
	}
...
// SetOrderID sets the "order_id" field.
func (u *PaymentAuditLogUpsert) SetOrderID(v int64) *PaymentAuditLogUpsert {
...
func (u *PaymentAuditLogUpsert) AddOrderID(v int64) *PaymentAuditLogUpsert {
	u.Add(paymentauditlog.FieldOrderID, v)
	return u
}
...
// SetOrderID sets the "order_id" field.
func (u *PaymentAuditLogUpsertOne) SetOrderID(v int64) *PaymentAuditLogUpsertOne {
...
// AddOrderID adds v to the "order_id" field.
func (u *PaymentAuditLogUpsertOne) AddOrderID(v int64) *PaymentAuditLogUpsertOne {
	return u.Update(func(s *PaymentAuditLogUpsert) {
		s.AddOrderID(v)
	})
}
...
// SetOrderID sets the "order_id" field.
func (u *PaymentAuditLogUpsertBulk) SetOrderID(v int64) *PaymentAuditLogUpsertBulk {
	return u.Update(func(s *PaymentAuditLogUpsert) {
		s.SetOrderID(v)
	})
}
...
// AddOrderID adds v to the "order_id" field.
func (u *PaymentAuditLogUpsertBulk) AddOrderID(v int64) *PaymentAuditLogUpsertBulk {
	return u.Update(func(s *PaymentAuditLogUpsert) {
		s.AddOrderID(v)
	})
}
