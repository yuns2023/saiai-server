...
func (_u *PaymentAuditLogUpdate) AddOrderID(v int64) *PaymentAuditLogUpdate {
...
func (_u *PaymentAuditLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedOrderID(); ok {
		_spec.AddField(paymentauditlog.FieldOrderID, field.TypeInt64, value)
	}
...
// AddOrderID adds value to the "order_id" field.
func (_u *PaymentAuditLogUpdateOne) AddOrderID(v int64) *PaymentAuditLogUpdateOne {
	_u.mutation.AddOrderID(v)
	return _u
}
