...
func (_u *GroupUpdate) SetAllowClaudeContext1mBeta(v bool) *GroupUpdate {
	_u.mutation.SetAllowClaudeContext1mBeta(v)
	return _u
}

// SetNillableAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableAllowClaudeContext1mBeta(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetAllowClaudeContext1mBeta(*v)
	}
	return _u
}

// SetClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field.
func (_u *GroupUpdate) SetClaudeOauthRequestGateDisabled(v bool) *GroupUpdate {
	_u.mutation.SetClaudeOauthRequestGateDisabled(v)
	return _u
}
...
func (_u *GroupUpdate) SetNillableClaudeOauthRequestGateDisabled(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetClaudeOauthRequestGateDisabled(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) SetBlockedModelPatterns(v []string) *GroupUpdate {
	_u.mutation.SetBlockedModelPatterns(v)
	return _u
}

// AppendBlockedModelPatterns appends value to the "blocked_model_patterns" field.
func (_u *GroupUpdate) AppendBlockedModelPatterns(v []string) *GroupUpdate {
	_u.mutation.AppendBlockedModelPatterns(v)
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AllowClaudeContext1mBeta(); ok {
		_spec.SetField(group.FieldAllowClaudeContext1mBeta, field.TypeBool, value)
	}
	if value, ok := _u.mutation.ClaudeOauthRequestGateDisabled(); ok {
	...
	if value, ok := _u.mutation.BlockedModelPatterns(); ok {
		_spec.SetField(group.FieldBlockedModelPatterns, field.TypeJSON, value)
	}
	if value, ok := _u.mutation.AppendedBlockedModelPatterns(); ok {
...
// SetAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field.
func (_u *GroupUpdateOne) SetAllowClaudeContext1mBeta(v bool) *GroupUpdateOne {
	_u.mutation.SetAllowClaudeContext1mBeta(v)
	return _u
}

// SetNillableAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableAllowClaudeContext1mBeta(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetAllowClaudeContext1mBeta(*v)
	}
	return _u
...
// SetClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field.
func (_u *GroupUpdateOne) SetClaudeOauthRequestGateDisabled(v bool) *GroupUpdateOne {
	_u.mutation.SetClaudeOauthRequestGateDisabled(v)
	return _u
}

// SetNillableClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableClaudeOauthRequestGateDisabled(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetClaudeOauthRequestGateDisabled(*v)
	}
	return _u
...
// SetBlockedModelPatterns sets the "blocked_model_patterns" field.
func (_u *GroupUpdateOne) SetBlockedModelPatterns(v []string) *GroupUpdateOne {
	_u.mutation.SetBlockedModelPatterns(v)
	return _u
}

// AppendBlockedModelPatterns appends value to the "blocked_model_patterns" field.
func (_u *GroupUpdateOne) AppendBlockedModelPatterns(v []string) *GroupUpdateOne {
	_u.mutation.AppendBlockedModelPatterns(v)
	return _u
}
