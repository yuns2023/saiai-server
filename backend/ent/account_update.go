...
func (_u *AccountUpdate) SetPaygDiscountMultiplier(v float64) *AccountUpdate {
...
func (_u *AccountUpdate) SetNillablePaygDiscountMultiplier(v *float64) *AccountUpdate {
	if v != nil {
...
func (_u *AccountUpdate) AddPaygDiscountMultiplier(v float64) *AccountUpdate {
...
func (_u *AccountUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedPaygDiscountMultiplier(); ok {
		_spec.AddField(account.FieldPaygDiscountMultiplier, field.TypeFloat64, value)
	}
...
// SetPaygDiscountMultiplier sets the "payg_discount_multiplier" field.
func (_u *AccountUpdateOne) SetPaygDiscountMultiplier(v float64) *AccountUpdateOne {
	_u.mutation.ResetPaygDiscountMultiplier()
	_u.mutation.SetPaygDiscountMultiplier(v)
	return _u
}
...
// SetNillablePaygDiscountMultiplier sets the "payg_discount_multiplier" field if the given value is not nil.
func (_u *AccountUpdateOne) SetNillablePaygDiscountMultiplier(v *float64) *AccountUpdateOne {
	if v != nil {
		_u.SetPaygDiscountMultiplier(*v)
	}
	return _u
...
// AddPaygDiscountMultiplier adds value to the "payg_discount_multiplier" field.
func (_u *AccountUpdateOne) AddPaygDiscountMultiplier(v float64) *AccountUpdateOne {
	_u.mutation.AddPaygDiscountMultiplier(v)
	return _u
}
