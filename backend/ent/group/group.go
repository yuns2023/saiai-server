...
const (
	...
	// FieldAllowClaudeContext1mBeta holds the string denoting the allow_claude_context_1m_beta field in the database.
	FieldAllowClaudeContext1mBeta = "allow_claude_context_1m_beta"
	// FieldClaudeOauthRequestGateDisabled holds the string denoting the claude_oauth_request_gate_disabled field in the database.
	FieldClaudeOauthRequestGateDisabled = "claude_oauth_request_gate_disabled"
...
var Columns = []string{
	...
	FieldClaudeCodeOnly,
	FieldAllowClaudeContext1mBeta,
	FieldClaudeOauthRequestGateDisabled,
...
var (
	...
	// DefaultAllowClaudeContext1mBeta holds the default value on creation for the "allow_claude_context_1m_beta" field.
	DefaultAllowClaudeContext1mBeta bool
	// DefaultClaudeOauthRequestGateDisabled holds the default value on creation for the "claude_oauth_request_gate_disabled" field.
...
// ByAllowClaudeContext1mBeta orders the results by the allow_claude_context_1m_beta field.
func ByAllowClaudeContext1mBeta(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAllowClaudeContext1mBeta, opts...).ToFunc()
}

// ByClaudeOauthRequestGateDisabled orders the results by the claude_oauth_request_gate_disabled field.
func ByClaudeOauthRequestGateDisabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldClaudeOauthRequestGateDisabled, opts...).ToFunc()
}
