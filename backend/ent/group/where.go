...
// AllowClaudeContext1mBeta applies equality check predicate on the "allow_claude_context_1m_beta" field. It's identical to AllowClaudeContext1mBetaEQ.
func AllowClaudeContext1mBeta(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldAllowClaudeContext1mBeta, v))
}

// ClaudeOauthRequestGateDisabled applies equality check predicate on the "claude_oauth_request_gate_disabled" field. It's identical to ClaudeOauthRequestGateDisabledEQ.
func ClaudeOauthRequestGateDisabled(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldClaudeOauthRequestGateDisabled, v))
}
...
// AllowClaudeContext1mBetaEQ applies the EQ predicate on the "allow_claude_context_1m_beta" field.
func AllowClaudeContext1mBetaEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldAllowClaudeContext1mBeta, v))
}

// AllowClaudeContext1mBetaNEQ applies the NEQ predicate on the "allow_claude_context_1m_beta" field.
func AllowClaudeContext1mBetaNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldAllowClaudeContext1mBeta, v))
}

// ClaudeOauthRequestGateDisabledEQ applies the EQ predicate on the "claude_oauth_request_gate_disabled" field.
func ClaudeOauthRequestGateDisabledEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldClaudeOauthRequestGateDisabled, v))
}

// ClaudeOauthRequestGateDisabledNEQ applies the NEQ predicate on the "claude_oauth_request_gate_disabled" field.
func ClaudeOauthRequestGateDisabledNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldClaudeOauthRequestGateDisabled, v))
}
