...
func (_c *GroupCreate) SetAllowClaudeContext1mBeta(v bool) *GroupCreate {
	_c.mutation.SetAllowClaudeContext1mBeta(v)
	return _c
}

// SetNillableAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field if the given value is not nil.
func (_c *GroupCreate) SetNillableAllowClaudeContext1mBeta(v *bool) *GroupCreate {
	if v != nil {
		_c.SetAllowClaudeContext1mBeta(*v)
	}
	return _c
}

// SetClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field.
func (_c *GroupCreate) SetClaudeOauthRequestGateDisabled(v bool) *GroupCreate {
	_c.mutation.SetClaudeOauthRequestGateDisabled(v)
	return _c
}

// SetNillableClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field if the given value is not nil.
func (_c *GroupCreate) SetNillableClaudeOauthRequestGateDisabled(v *bool) *GroupCreate {
	if v != nil {
		_c.SetClaudeOauthRequestGateDisabled(*v)
	}
	return _c
}
...
func (_c *GroupCreate) defaults() error {
	...
	if _, ok := _c.mutation.AllowClaudeContext1mBeta(); !ok {
		v := group.DefaultAllowClaudeContext1mBeta
		_c.mutation.SetAllowClaudeContext1mBeta(v)
	}
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.AllowClaudeContext1mBeta(); !ok {
		return &ValidationError{Name: "allow_claude_context_1m_beta", err: errors.New(`ent: missing required field "Group.allow_claude_context_1m_beta"`)}
	}
	if _, ok := _c.mutation.ClaudeOauthRequestGateDisabled(); !ok {
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AllowClaudeContext1mBeta(); ok {
		_spec.SetField(group.FieldAllowClaudeContext1mBeta, field.TypeBool, value)
		_node.AllowClaudeContext1mBeta = value
	}
	if value, ok := _c.mutation.ClaudeOauthRequestGateDisabled(); ok {
		_spec.SetField(group.FieldClaudeOauthRequestGateDisabled, field.TypeBool, value)
		_node.ClaudeOauthRequestGateDisabled = value
	}
...
// SetAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field.
func (u *GroupUpsert) SetAllowClaudeContext1mBeta(v bool) *GroupUpsert {
	u.Set(group.FieldAllowClaudeContext1mBeta, v)
	return u
}

// UpdateAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field to the value that was provided on create.
func (u *GroupUpsert) UpdateAllowClaudeContext1mBeta() *GroupUpsert {
	u.SetExcluded(group.FieldAllowClaudeContext1mBeta)
	return u
}

// SetClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field.
func (u *GroupUpsert) SetClaudeOauthRequestGateDisabled(v bool) *GroupUpsert {
	u.Set(group.FieldClaudeOauthRequestGateDisabled, v)
	return u
}

// UpdateClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field to the value that was provided on create.
func (u *GroupUpsert) UpdateClaudeOauthRequestGateDisabled() *GroupUpsert {
	u.SetExcluded(group.FieldClaudeOauthRequestGateDisabled)
	return u
}
...
// SetAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field.
func (u *GroupUpsertOne) SetAllowClaudeContext1mBeta(v bool) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetAllowClaudeContext1mBeta(v)
	})
}

// UpdateAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateAllowClaudeContext1mBeta() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateAllowClaudeContext1mBeta()
	})
}

// SetClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field.
func (u *GroupUpsertOne) SetClaudeOauthRequestGateDisabled(v bool) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetClaudeOauthRequestGateDisabled(v)
	})
}

// UpdateClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateClaudeOauthRequestGateDisabled() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateClaudeOauthRequestGateDisabled()
	})
}
...
// SetAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field.
func (u *GroupUpsertBulk) SetAllowClaudeContext1mBeta(v bool) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetAllowClaudeContext1mBeta(v)
	})
}
...
// UpdateAllowClaudeContext1mBeta sets the "allow_claude_context_1m_beta" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateAllowClaudeContext1mBeta() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateAllowClaudeContext1mBeta()
	})
}
...
// SetClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field.
func (u *GroupUpsertBulk) SetClaudeOauthRequestGateDisabled(v bool) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetClaudeOauthRequestGateDisabled(v)
	})
}
...
// UpdateClaudeOauthRequestGateDisabled sets the "claude_oauth_request_gate_disabled" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateClaudeOauthRequestGateDisabled() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateClaudeOauthRequestGateDisabled()
	})
}
