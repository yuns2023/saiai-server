...
func (*PaymentProviderInstance) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentproviderinstance.FieldBalanceCreditRate:
			values[i] = new(sql.NullFloat64)
		case paymentproviderinstance.FieldID, paymentproviderinstance.FieldSortOrder:
			values[i] = new(sql.NullInt64)
		case paymentproviderinstance.FieldProviderKey, paymentproviderinstance.FieldName, paymentproviderinstance.FieldConfigEncrypted, paymentproviderinstance.FieldSupportedTypes, paymentproviderinstance.FieldLimits:
