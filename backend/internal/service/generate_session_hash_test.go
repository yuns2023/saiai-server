...
func TestGenerateSessionHash_MetadataJSON_HasHighestPriority(t *testing.T) {
	...
	parsed := &ParsedRequest{
		MetadataUserID: `{"device_id":"a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2","account_uuid":"","session_id":"00000000-0000-4000-8000-000000000008"}`,
		System:         "You are a helpful assistant.",
		HasSystem:      true,
		Messages: []any{
			map[string]any{"role": "user", "content": "hello"},
	...
	hash := svc.GenerateSessionHash(parsed)
	require.Equal(t, "00000000-0000-4000-8000-000000000008", hash, "JSON format metadata session_id should have highest priority")
}
