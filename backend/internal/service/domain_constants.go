...
const (
	...
	RedeemTypeClaudeDevice = domain.RedeemTypeClaudeDevice
)
...
const (
	...
	SettingKeyAPIEndpoints                = "api_endpoints"                 // 可供用户选择的 API 线路（JSON 数组）
	...
	// SettingKeyOpsFullRequestBodyLogging stores temporary per-API-key request
	// body capture settings for ops troubleshooting.
	SettingKeyOpsFullRequestBodyLogging = "ops_full_request_body_logging"
	...
	SettingKeyMaintenanceMessage     = "maintenance_message"
)
