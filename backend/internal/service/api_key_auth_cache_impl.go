...
func (s *APIKeyService) deleteAuthCache(ctx context.Context, cacheKey string) {
	if s.authCacheL1 != nil {
		s.authCacheL1.Del(cacheKey)
		// Ristretto applies write-side mutations asynchronously. Wait here so
		// admin-side key updates (for example binding a group) become visible to
		// the very next authenticated request on the same instance.
		s.authCacheL1.Wait()
	}
	if s.cache == nil {
		return
...
func (s *APIKeyService) snapshotFromAPIKey(apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		User: APIKeyAuthUserSnapshot{
			...
			PaygDiscountOverrideEnabled: apiKey.User.PaygDiscountOverrideEnabled,
			EffectiveLevel:              apiKey.User.EffectiveAccessLevel(),
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			RequiredLevel:                    apiKey.Group.RequiredLevel,
			...
			AllowClaudeContext1MBeta:         apiKey.Group.AllowClaudeContext1MBeta,
			ClaudeOAuthRequestGateDisabled:   apiKey.Group.ClaudeOAuthRequestGateDisabled,
			ClaudeEnvironmentMode:            apiKey.Group.EffectiveClaudeEnvironmentMode(),
			ClaudeEnvironmentRewrite:         apiKey.Group.EffectiveClaudeEnvironmentMode() == ClaudeEnvironmentModeRewrite,
			FallbackGroupID:                  apiKey.Group.FallbackGroupID,
			FallbackGroupIDOnInvalidRequest:  apiKey.Group.FallbackGroupIDOnInvalidRequest,
			ModelRouting:                     apiKey.Group.ModelRouting,
			ModelRoutingEnabled:              apiKey.Group.ModelRoutingEnabled,
			BlockedModelPatterns:             apiKey.Group.BlockedModelPatterns,
			MCPXMLInject:                     apiKey.Group.MCPXMLInject,
			SupportedModelScopes:             apiKey.Group.SupportedModelScopes,
			InputModerationEnabled:           apiKey.Group.InputModerationEnabled,
			InputModerationAutoDisableUser:   apiKey.Group.InputModerationAutoDisableUser,
			InputModerationCategories:        apiKey.Group.InputModerationCategories,
			InputModerationActionMode:        apiKey.Group.InputModerationActionMode,
			InputModerationCooldownMinutes:   apiKey.Group.InputModerationCooldownMinutes,
			InputModerationDisableAfterHits:  apiKey.Group.InputModerationDisableAfterHits,
			InputModerationStrikeWindowHours: apiKey.Group.InputModerationStrikeWindowHours,
			InputModerationDedupeMinutes:     apiKey.Group.InputModerationDedupeMinutes,
			CodexClientPolicy:                apiKey.Group.CodexClientPolicy,
			ClaudeDeviceLimitMode:            apiKey.Group.ClaudeDeviceLimitMode,
			ClaudeDeviceBaseLimit:            apiKey.Group.ClaudeDeviceBaseLimit,
		}
	}
	return snapshot
}
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		User: &User{
			...
			PaygDiscountOverrideEnabled: snapshot.User.PaygDiscountOverrideEnabled,
			AutoLevel:                   snapshot.User.EffectiveLevel,
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			RequiredLevel:                    snapshot.Group.RequiredLevel,
			...
			AllowClaudeContext1MBeta:         snapshot.Group.AllowClaudeContext1MBeta,
			ClaudeOAuthRequestGateDisabled:   snapshot.Group.ClaudeOAuthRequestGateDisabled,
			ClaudeEnvironmentMode:            NormalizeClaudeEnvironmentMode(snapshot.Group.ClaudeEnvironmentMode, snapshot.Group.ClaudeEnvironmentRewrite),
			ClaudeEnvironmentRewrite:         snapshot.Group.ClaudeEnvironmentRewrite,
			FallbackGroupID:                  snapshot.Group.FallbackGroupID,
			FallbackGroupIDOnInvalidRequest:  snapshot.Group.FallbackGroupIDOnInvalidRequest,
			ModelRouting:                     snapshot.Group.ModelRouting,
			ModelRoutingEnabled:              snapshot.Group.ModelRoutingEnabled,
			BlockedModelPatterns:             snapshot.Group.BlockedModelPatterns,
			MCPXMLInject:                     snapshot.Group.MCPXMLInject,
			SupportedModelScopes:             snapshot.Group.SupportedModelScopes,
			InputModerationEnabled:           snapshot.Group.InputModerationEnabled,
			InputModerationAutoDisableUser:   snapshot.Group.InputModerationAutoDisableUser,
			InputModerationCategories:        snapshot.Group.InputModerationCategories,
			InputModerationActionMode:        snapshot.Group.InputModerationActionMode,
			InputModerationCooldownMinutes:   snapshot.Group.InputModerationCooldownMinutes,
			InputModerationDisableAfterHits:  snapshot.Group.InputModerationDisableAfterHits,
			InputModerationStrikeWindowHours: snapshot.Group.InputModerationStrikeWindowHours,
			InputModerationDedupeMinutes:     snapshot.Group.InputModerationDedupeMinutes,
			CodexClientPolicy:                snapshot.Group.CodexClientPolicy,
			ClaudeDeviceLimitMode:            snapshot.Group.ClaudeDeviceLimitMode,
			ClaudeDeviceBaseLimit:            snapshot.Group.ClaudeDeviceBaseLimit,
		}
	}
