...
type OpsRepository interface {
	...
	InsertRequestCapture(ctx context.Context, input *OpsInsertRequestCaptureInput) (int64, error)
...
type OpsInsertRequestCaptureInput struct {
	Outcome string
	...
	InboundRequestHeadersJSON *string
	InboundRequestBody        *string
	InboundRequestTruncated   bool
	InboundRequestBytes       *int

	UpstreamRequestMethod      string
	UpstreamRequestURL         string
	UpstreamRequestHeadersJSON *string
	UpstreamRequestBody        *string
	UpstreamRequestTruncated   bool
	UpstreamRequestBytes       *int

	UpstreamResponseHeadersJSON *string
