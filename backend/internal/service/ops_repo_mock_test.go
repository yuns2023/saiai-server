...
type opsRepoMock struct {
	...
	InsertRequestCaptureFn        func(ctx context.Context, input *OpsInsertRequestCaptureInput) (int64, error)
...
func (m *opsRepoMock) InsertRequestCapture(ctx context.Context, input *OpsInsertRequestCaptureInput) (int64, error) {
	if m.InsertRequestCaptureFn != nil {
		return m.InsertRequestCaptureFn(ctx, input)
	}
	return 0, nil
}
