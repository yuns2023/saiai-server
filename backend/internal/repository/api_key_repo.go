	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldAllowClaudeContext1mBeta,
				group.FieldClaudeOauthRequestGateDisabled,
				group.FieldFallbackGroupID,
				group.FieldFallbackGroupIDOnInvalidRequest,
				group.FieldModelRoutingEnabled,
				group.FieldModelRouting,
				group.FieldBlockedModelPatterns,
				group.FieldMcpXMLInject,
				group.FieldSupportedModelScopes,
				group.FieldInputModerationEnabled,
				group.FieldInputModerationAutoDisableUser,
				group.FieldInputModerationCategories,
				group.FieldInputModerationActionMode,
				group.FieldInputModerationCooldownMinutes,
				group.FieldInputModerationDisableAfterHits,
				group.FieldInputModerationStrikeWindowHours,
				group.FieldInputModerationDedupeMinutes,
				group.FieldCodexClientPolicy,
