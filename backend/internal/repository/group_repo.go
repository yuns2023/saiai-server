...
func (r *groupRepository) Create(ctx context.Context, groupIn *service.Group) error {
	...
	modelRates := groupIn.ModelRateMultipliers
	if modelRates == nil {
	...
	builder := r.client.Group.Create().
		...
		SetAllowClaudeContext1mBeta(groupIn.AllowClaudeContext1MBeta).
		SetClaudeOauthRequestGateDisabled(groupIn.ClaudeOAuthRequestGateDisabled).
	...
	builder = builder.SetModelRateMultipliers(modelRates)
