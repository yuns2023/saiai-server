...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/:id/claude-devices", h.Admin.User.ListClaudeDevices)
		users.DELETE("/:id/claude-devices/:device_id", h.Admin.User.RevokeClaudeDevice)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/claude-pinned-binding", h.Admin.Account.GetClaudePinnedBinding)
		accounts.DELETE("/:id/claude-pinned-binding", h.Admin.Account.DeleteClaudePinnedBinding)
		...
		accounts.POST("/:id/clear-quota-snapshot", h.Admin.Account.ClearQuotaSnapshot)
