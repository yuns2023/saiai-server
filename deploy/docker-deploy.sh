...
GITHUB_RAW_URL="https://raw.githubusercontent.com/yuns2023/saiai-server/main/deploy"
...
main() {
    ...
    echo "=========================================="
    echo ""
    echo "Generated secure credentials were written to .env (values are not printed)."
    echo ""
