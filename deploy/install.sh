...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/yuns2023/saiai-server/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="yuns2023/saiai-server"
...
Documentation=https://github.com/yuns2023/saiai-server
